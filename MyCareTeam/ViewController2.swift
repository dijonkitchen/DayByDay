...
extension ViewController2: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
    ...
    func supplementaryView(viewOnDayView dayView: DayView) -> UIView {
        ...
        newView = UIView(frame: dayView.bounds)
...
extension ViewController2: CVCalendarViewAppearanceDelegate {
